...
namespace Integration
{
     ...
     *
     * @link https://gleb-mihalkov.github.io/php-process-api/class-Process.Base.html \Process\Base
     */
    trait Revertable
    {
        /**
         * Выполняется при необходимости подтверждения изменений в процессе.
         * @return void
         */
        protected function commit() {}

        /**
         * Выполняется при необходимости отмены изменений в процессе.
         * @return void
         */
